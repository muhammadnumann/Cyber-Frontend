...
import InvestigationModal from "../Investigation/InvestigationModal";
...
function AdminAccordianDetailSection(row) {
  return (
    <>
      <Grid
        container
  ...
  return (
    <>
      <Accordion key={index} expanded={expanded === `panel${index}`}>
        ...
        <AccordionDetails>
          <AdminAccordianDetailSection row={row} />
        </AccordionDetails>
      </Accordion>
...
export default function AdminInvestigationList({ selectedButton }) {
  return (
    <>
