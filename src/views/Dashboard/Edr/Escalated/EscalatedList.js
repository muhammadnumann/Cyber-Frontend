...
import EsclatedAssigneeModal from "../../EsclatedAssigneeModal";
...
const AccordianSection = ({ row, index }) => {
  ...
  return (
    <>
      ...
      <EsclatedAssigneeModal open={open} handleClose={handleClose} />
    </>
  );
};
export default function EDREscalatedList({ selectedButton }) {
  return (
    <>
      <Box
        sx={{
